...
fftm = signal.fftconvolve(mask, arr)
...
ax_orig.imshow(a)
normalized = fftc/fftm[64:703,64:703]
ay_orig.imshow(normalized)
ax_orig.set_title('Original')
ay_orig.set_title('Normalized Con')
...
ax_conv.imshow(normalized[64:576,64:576])
ay_conv.set_title('Pooled')
ax_conv.set_title('Normalized Cropped')
